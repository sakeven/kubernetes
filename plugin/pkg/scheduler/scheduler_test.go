...
func podWithID(id, desiredHost string) *v1.Pod {
	return &v1.Pod{
		ObjectMeta: metav1.ObjectMeta{Name: id, SelfLink: testapi.Default.SelfLink(string(v1.ResourcePods), id)},
		Spec: v1.PodSpec{
...
func deletingPod(id string) *v1.Pod {
	...
	return &v1.Pod{
		ObjectMeta: metav1.ObjectMeta{Name: id, SelfLink: testapi.Default.SelfLink(string(v1.ResourcePods), id), DeletionTimestamp: &deletionTimestamp},
		Spec: v1.PodSpec{
			NodeName: "",
		},
	}
